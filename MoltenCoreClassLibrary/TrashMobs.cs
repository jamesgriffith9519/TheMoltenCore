...
{
    public class TrashMobs : Character
    {
        ...
        public TrashMobs(string name, int life, int maxLife, int hitRating, int dodgeRating, int minDamage, int maxDamage, string description)
        {
            Name = name;
            MaxLife = maxLife;
            Life = life;
